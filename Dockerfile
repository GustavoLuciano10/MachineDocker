...
# Configuração do Apache com apenas o ProxyPass (sem reescrita)
...
# Corrigir prefixo estático do shellinabox
CMD service apache2 start && \
    shellinaboxd --no-beep --disable-ssl --static-url-prefix=/shellinabox/ --port=4200 -s /:LOGIN && \
